...
<div align="center"> 
  <a href="https://git.io/typing-svg"> 
    <img src="https://readme-typing-svg.demolab.com?font=Ribeye&size=50&pause=1000&color=33ff00&center=true&width=910&height=100&lines=Knight-Bot;Multi+Device+Whatsapp+Bot;Coded+By+Legend Haider" alt="Typing SVG" />
  </a> 
</div> 

<div align="center"> 
  <a href=> 
    <img src="https://files.catbox.moe/fl6zep.jpeg" alt="Legend MD Bot" height="300"> 
  </a> 
</div>
...
Click the button below to fork the Legend MD Bot repository to your GitHub account:
...
The Legend MD WhatsApp Bot assists group admins by providing them with tools to efficiently manage large WhatsApp groups. The bot uses the Baileys library to interact with the WhatsApp Web API and supports multi-device features.
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https:https://github.com/haiderkhan293/LEGEND-MD-BOT
    ```
